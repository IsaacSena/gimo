    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-center flex-grow-1" style="padding-top:35px;">
        <ul class="navbar-nav d-flex flex-row gap-3">
          <li class="nav-item">
            <a href="/" class="btn btn-danger" style="border: 2px solid black; border-radius: 30px; padding: 12px 24px; font-size: 18px;">Home</a>
          </li>
          <li class="nav-item">
            <a href="/sobrenos" class="btn btn-danger" style="border: 2px solid black; border-radius: 30px; padding: 12px 24px; font-size: 18px;">Sobre</a>
          </li>
          <li class="nav-item">
            <a href="/loginUsuario" class="btn btn-danger" style="border: 2px solid black; border-radius: 30px; padding: 12px 24px; font-size: 18px;">Atividade</a>
          </li>
          <li class="nav-item">
            <a href="/loginUsuario" class="btn btn-danger" style="border: 2px solid black; border-radius: 30px; padding: 12px 24px; font-size: 18px;">Relatório</a>
          </li>
        </ul>
      </div>
